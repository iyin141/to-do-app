    ...
    <div >
      ...
      <div className='overflow-x-hidden flex flex-col md:pt-[8.5%]  items-center bg-[url("/img/hero_2.png")] pb-12    bg-cover  bg-top w-[72vw] max-sm:w-[100vw]'>
        <div className='flex flex-col  text-center justify-center'>
          ...
          <h1 className=' mx-auto text-[6vw] max-sm:text-[2.5rem] text-black font-medium  text-center lg:leading-20 xl:leading-[15vh] md:pb-8 max-sm:pb-4 w-[85%]'>Track & manage your tasks easily and organized </h1>
