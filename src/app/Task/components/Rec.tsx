...
const Rec = () => {
  return (
    <div className={`${caprasimo.className} `}>
      <h1 className={` font-semibold text-[1.1rem] max-sm:pl-4 max-sm:pb-4 md:pb-12`}>Recommend Categories</h1>
      <div className='flex md:gap-6 max-sm:gap-5  max-sm:justify-center max-sm:flex-wrap'>
        {Categories.map((cat) => {
          const Icon = cat.icon
          return (
